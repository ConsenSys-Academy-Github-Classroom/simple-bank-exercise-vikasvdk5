...
contract SimpleBank {
    ...
    // Event to enit when account is overdrawn
    event LogNotEnoughFundsToWithdraw(address  accountAddress, uint amount);
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      // 3. Emit the appropriate event for this message
          ...
          emit LogNotEnoughFundsToWithdraw(msg.sender,curBalance);
          revert();
        }
    }
}
